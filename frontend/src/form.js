...
const Form=()=>{
    ...
    const handlesubmit=(e)=>{
        ...
        axios.post('http://localhost:5000/addstudent',{formdata}).then((result)=>{console.log(result.body)})
    }
    return(
        <>
        <form onSubmit={handlesubmit}>
            ...
            <br/>
            <label>College:</label>
            <input type="text" name="clg" onChange={(e)=>setFormdata({...formdata,clg:e.target.value})}/>
            <br/>
            <label>Branch:</label>
